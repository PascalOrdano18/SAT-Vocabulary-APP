    ...
    <>
      ...
      <div className="w-screen h-screen flex flex-col bg-blue-900">
        ...
        <div className="mx-auto mt-20 max-w-[740px]">
            ...
            <p className="w-fit mx-auto my-16 text-xl">A definition will be given with four possible corresponding words, but only one word is the correct answer. Good Luck</p>
        </div>
